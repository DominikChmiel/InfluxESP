 ...
 *   @returns the 16 bit data value read from the device
 */
int16_t BME280Aggregator::readS16(byte reg) { return (int16_t)read16(reg); }
...
int32_t BME280Aggregator::adaptHumidity(uint32_t raw_humidity) {
  ...
  v_x1_u32r = (((((raw_humidity << 14) - (((int32_t)_bme280_calib.dig_H4) << 20) -
 ...
 */
uint32_t BME280Aggregator::sensorID(void) { return _sensorID; }